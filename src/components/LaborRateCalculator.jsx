...
const STEP2_BURDEN_GRID = 'grid w-full min-w-0 grid-cols-[3.25rem_3.25rem_4.4rem] gap-1.5'
// Step 3: three-column burden grid (same as Division / General / Profit overhead rows)
const STEP3_BURDEN3_WRAP = 'w-[11.15rem] max-w-full shrink-0'
const STEP3_BURDEN3_GRID = 'grid w-full min-w-0 grid-cols-[3rem_3rem_4.4rem] gap-1.5'
                      ...
                      <div key={option.id} className="flex flex-col gap-2 p-1.5 border border-gray-200 rounded-lg hover:bg-gray-50 min-w-0 -ml-[10px]">
                        ...
                        <div className="flex flex-col items-end justify-center gap-0.5 min-w-0 pl-0.5 pr-2 overflow-visible">
                          <input
                            ...
                            className="burden-input w-[4.3rem] px-1 py-0.5 bg-white border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary text-right text-xs no-spinner"
                            placeholder="0.00"
                          />
                          <FieldLockButton
